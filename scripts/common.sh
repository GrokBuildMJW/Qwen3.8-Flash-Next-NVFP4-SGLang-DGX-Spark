...
IMAGE_DIGEST="${IMAGE_DIGEST:-sha256:12d3392bdc8be8d35e9a95f191df6aef99c5114bdbefd41bfdc7e760e6d25ec1}"
...
# Ironclad spark profile. Override only if you are not serving that client.
PORT="${PORT:-8000}"
